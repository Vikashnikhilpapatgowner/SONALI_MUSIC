...
def stream_markup_timer(_, videoid, chat_id, played, dur):
    ...
    buttons = [
      ...
      [
            InlineKeyboardButton(
                text="𝖮ᴡɴᴇʀ 🥀", url="https://t.me/God_father_hu",
            ),
            InlineKeyboardButton(
                text="𝖲ᴜᴘᴘᴏʀᴛ 🥀", url="https://t.me/Progressive_panday_ji2636",
            )
        ],
...
def stream_markup(_, videoid, chat_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="𝖮𝗐𝗇𝖾𝗋🥀", url="https://t.me/God_father_hu",
            ),
            InlineKeyboardButton(
                text="𝖲𝗎𝗉𝗉𝗈𝗋𝗍🥀", url="https://t.me/Progressive_panday_ji2636",
            )
        ],
        [InlineKeyboardButton(text=_["CLOSE_BUTTON"], callback_data="close")],
    ]

...
# -------------------------------------------------------
OWNER_USERNAME = getenv("OWNER_USERNAME","God_father_hu")
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME","GOD_FATHER_MUSIC_robot")
# --------------------------------------------------------
...
OWNER_ID = int(getenv("OWNER_ID", 5904708051))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/MTSTUDIO84/Vikasbhaikirepo",
)
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Progressive_panday_ji2636")
